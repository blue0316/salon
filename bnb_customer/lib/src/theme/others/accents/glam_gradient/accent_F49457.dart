...
const _accentColor = Color(0XFFF49457);

final ThemeData accentF49457 = ThemeData(
  ...
  colorScheme: ColorScheme(
    ...
    surfaceVariant: const Color(0XFFF49457),
    onSurfaceVariant: const Color(0XFFFFD54A),
    surfaceTint: const Color(0XFF63E24F),
  ),
  textTheme: TextTheme(
