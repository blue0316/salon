...
const _accentColor = Color(0XFF58DDEF);

final ThemeData accent58DDEF = ThemeData(
  ...
  colorScheme: ColorScheme(
    ...
    surfaceVariant: const Color(0XFF58DDEF),
    onSurfaceVariant: const Color(0XFFFFA99E),
    surfaceTint: const Color(0XFFFFA99E),
  ),
  textTheme: TextTheme(
