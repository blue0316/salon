...
import 'widgets/calender_cole.dart';
...
class _TableCalendarBaseState extends State<TableCalendarBase> {
  ...
  void didUpdateWidget(TableCalendarBase oldWidget) {
    ...
    if (widget.rowHeight != oldWidget.rowHeight || widget.dowHeight != oldWidget.dowHeight || widget.dowVisible != oldWidget.dowVisible || widget.sixWeekMonthsEnforced != oldWidget.sixWeekMonthsEnforced) {
      final rowCount = _getRowCount(widget.calendarFormat, _focusedDay);
        ...
        return SimpleGestureDetector(
          ...
          child: ValueListenableBuilder<double>(
            ...
            child: CalendarCore(
              ...
              scrollPhysics: _canScrollHorizontally ? const PageScrollPhysics() : const NeverScrollableScrollPhysics(),
