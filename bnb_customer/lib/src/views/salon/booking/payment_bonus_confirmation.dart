...
class PaymentBonusConfirmation extends ConsumerStatefulWidget {
  ...
  @override
  _PaymentBonusConfirmationState createState() =>
      _PaymentBonusConfirmationState();
}

class _PaymentBonusConfirmationState
    extends ConsumerState<PaymentBonusConfirmation> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(AppLocalizations.of(context)?.payment ?? "Payment",
                style: Theme.of(context).textTheme.headline4),
            Text(Time()
                .getLocaleDate(_createAppointment.chosenDay,
            ...
            child: ConstrainedContainer(
              child: Column(
                children: [
                  ...
                  if (double.parse(_createAppointment
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              settings:
                                  const RouteSettings(name: MyBonuses.route),
                        ...
                        child: Row(
                          ...
                          children: [
                            if (_createAppointment.chosenBonus == null) ...[
                              Text(
                                  AppLocalizations.of(context)?.useYourBonus ??
                                      "Use your Bonus",
                  ...
                  if (_createAppointment.chosenBonus != null) ...[
                    if (double.parse(_createAppointment
                      ...
                      Padding(
                        ...
                        child: Text(
                            "${AppLocalizations.of(context)?.bonusValidAbove} 300 ${Keys.uah}",
                            style: Theme.of(context).textTheme.subtitle1),
                      ),
                    ],
                  ],
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: AppTheme.oliveLight.withOpacity(0.7),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                  AppLocalizations.of(context)?.youHaveToPay ??
                                      "You have to pay:",
                              ...
                              Row(
                                ...
                                children: [
                                  if (_createAppointment.chosenBonus !=
                                      null) ...[
                                    Text(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  if (_createAppointment.appointmentModel !=
                                      null) ...[
                                    for (Service service in _createAppointment
                                        .appointmentModel!.services)
                                      Padding(
                                        padding:
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              int.parse(service
                                                          ...
                                                          .price) >
                                                      0
                                                  ? "${service.priceAndDurationMax!.price} ${Keys.uah}"
              ...
              onPressed: _status == Status.init
                  ? () async {
                      ...
                      try {
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(AppLocalizations.of(context)?.doneOnly ??
                                      "done"),
                                  Text(
                                    (_createAppointment
                        ...
                        Navigator.popUntil(
                            context, ModalRoute.withName(NavigatorPage.route));
                      }
                    }
                  : null,
              ...
              child: Row(
                ...
                children: [
                  if (_status == Status.init) ...[
                    Text(
                      (_createAppointment.appointmentModel?.status ?? "") ==
                              AppointmentStatus.requested
