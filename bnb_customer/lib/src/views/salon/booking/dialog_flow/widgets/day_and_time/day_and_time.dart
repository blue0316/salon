                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: theme.textTheme.bodyLarge!.copyWith(
                                              fontSize: 16.sp,
                                              fontWeight: FontWeight.normal,
                                              color: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.GlamMinimalDark ? selectSlots(themeType, theme) : Colors.white,
                                              fontFamily: 'Inter-Medium',
                                            ),
                                          ),
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                style: theme.textTheme.bodyLarge!.copyWith(
                                                  fontSize: 14.sp,
                                                  fontWeight: FontWeight.normal,
                                                  color: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.GlamMinimalDark ? selectSlots(themeType, theme)?.withOpacity(0.8) : Colors.white,
                                              ...
                                              Padding(
                                                ...
                                                child: CircleAvatar(
                                                  ...
                                                  backgroundColor: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.GlamMinimalDark ? selectSlots(themeType, theme) : Colors.white,
                                                ),
                                              ),
                                              SizedBox(width: 7.sp),
                                              Text(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: theme.textTheme.bodyLarge!.copyWith(
                                              fontSize: 14.sp,
                                              fontWeight: FontWeight.normal,
                                              color: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.GlamMinimalDark ? selectSlots(themeType, theme)?.withOpacity(0.7) : Colors.white,
                                              fontFamily: 'Inter-Medium',
                                            ),
                                          ),
                                        ],
