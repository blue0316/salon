...
//                       InkWell(
//                           onTap: () {
//                             print(_createAppointmentProvider.groupUnavailableSelectedItems);

//                             _createAppointmentProvider.groupUnavailableSelectedItems.forEach((key, value) {
//                               print(key);
//                               for (ServiceModel service in value) {
...
//                       //       //   child: ListView.builder(
//                       //       //     shrinkWrap: true,
//                       //       //     itemCount: _createAppointmentProvider.groupUnavailableSelectedItems.length,
//                       //       //     physics: const NeverScrollableScrollPhysics(),
//                       //       //     itemBuilder: (context, index) {
//                       //       //       String categoryId = _createAppointmentProvider.groupUnavailableSelectedItems.entries.
//                       //       //       ServiceModel service = _createAppointmentProvider.unavailableSelectedItems[index];
//                       //       //       bool isAdded = _createAppointmentProvider.isAdded(serviceModel: service);
//                       //       //       List<ServiceModel> subItems = _createAppointmentProvider.unavailableSelectedItems;
//                       //       //       return Column(
//                       //       //         children: [
//                       //       //           GestureDetector(
//                       //       //             onTap: () {
