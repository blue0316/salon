...
class MasterContactUnique extends ConsumerStatefulWidget {
  ...
  const MasterContactUnique({Key? key, required this.masterModel})
      : super(key: key);

  @override
  ConsumerState<MasterContactUnique> createState() =>
      _MasterContactUniqueState();
}

class _MasterContactUniqueState extends ConsumerState<MasterContactUnique>
    ...
    return Container(
      decoration: themeType == ThemeType.Barbershop
          ? BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                  isPortrait
                      ? ThemeImages.footerLongGradientBG
                      : ThemeImages.footerGradientBG,
                ),
                fit: BoxFit.cover,
              ),
            )
      ...
      child: Padding(
        padding: EdgeInsets.only(
          ...
          bottom:
              100, // DeviceConstraints.getResponsiveSize(context, 100.h, 120.h, 140.h), // 120,
        ),
...
class MasterContactDefaultView extends ConsumerWidget {
  ...
  const MasterContactDefaultView({Key? key, required this.masterModel})
      : super(key: key);
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height:
              DeviceConstraints.getResponsiveSize(context, 550.h, 310.h, 300.h),
          child: Padding(
