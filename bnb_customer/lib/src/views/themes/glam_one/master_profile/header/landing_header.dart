...
class MasterLandingHeader extends ConsumerWidget {
  ...
  const MasterLandingHeader({Key? key, required this.masterModel})
      : super(key: key);
...
Widget headerTheme(
    ThemeType themeType, SalonModel salon, MasterModel masterModel) {
  switch (themeType) {
    case ThemeType.GentleTouch:
      return GentleTouchHeader(
          chosenSalon: salon, masterModel: masterModel, isSalonMaster: true);

    case ThemeType.CityMuseLight:
      return MinimalHeader(
          salonModel: salon, masterModel: masterModel, isSalonMaster: true);
    ...
    default:
      return DefaultLandingHeaderView(
          chosenSalon: salon, masterModel: masterModel, isSalonMaster: true);
  }
}
