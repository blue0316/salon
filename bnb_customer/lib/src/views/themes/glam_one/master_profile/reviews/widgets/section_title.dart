...
class _ReviewSectionTitleState extends ConsumerState<ReviewSectionTitle> {
  ...
  Widget build(BuildContext context) {
    ...
    final _ratingStr = widget.masterModel.avgRating.toString();
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            RatingBar.builder(
              initialRating: widget.masterModel.avgRating ?? 0,
              minRating: 0,
            ...
            const SizedBox(width: 15),
            Text(
              "${ref.watch(salonProfileProvider).masterReviews.length} ${AppLocalizations.of(context)?.reviews ?? 'Reviews'}",
