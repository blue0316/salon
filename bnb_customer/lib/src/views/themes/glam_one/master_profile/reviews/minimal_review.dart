...
class MinimalReviewView extends ConsumerStatefulWidget {
  ...
  const MinimalReviewView({Key? key, required this.masterModel, required this.controller}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ScrollablePositionedList.builder(
        ...
        itemCount: ref.watch(salonProfileProvider).masterReviews.length,
        itemBuilder: (context, index) {
          final ReviewModel review = ref.watch(salonProfileProvider).masterReviews[index];
