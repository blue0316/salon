...
import 'package:bbblient/src/views/themes/components/team/follow.dart';
...
class VintageCraftDesktopMasterView extends ConsumerStatefulWidget {
  final List<MasterModel> masters;
  final int initialIndex;
  const VintageCraftDesktopMasterView({
    Key? key,
  ...
  @override
  ConsumerState<VintageCraftDesktopMasterView> createState() => _VintageCraftDesktopMasterViewState();
}

class _VintageCraftDesktopMasterViewState extends ConsumerState<VintageCraftDesktopMasterView> {
  int indexToShow = 0;
