...
class _DayAndTimeState extends ConsumerState<DayAndTime> {
  ...
  init() async {
    ...
    setState(() {
      selectedMaster =
          _createAppointmentProvider.mastersOfferingChosenServices.toList()[0];
    });

    masterAndSalonPriceDifferent =
        _createAppointmentProvider.checkIfSalonPriceAndMasterPriceIsDifferent();
  ...
  Widget build(BuildContext context) {
    ...
    return loading
        ...
        : (_createAppointmentProvider.salonMasters.isEmpty ||
                _createAppointmentProvider
                    .mastersOfferingChosenServices.isEmpty)
            ? Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: DeviceConstraints.getResponsiveSize(
                        context, 17.w, 20.w, 20.w)),
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context)
                              ?.noMasterIsAvailableForSelectedServices ??
                    ...
                    child: ListView(
                      ...
                      children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    AppLocalizations.of(context)
                                            ?.serviceProvidersChargeDifferentPrices ??
                                        "Service providers charge different prices",
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: _createAppointmentProvider
                                        .mastersOfferingChosenServices.length,
                                    physics:
                        ...
                        HorizontalDatePicker(
                          ...
                          itemBuilder:
                              (DateTime itemValue, DateTime? selected) {
                            var isSelected = selected
                                    ?.difference(itemValue)
                                    .inMilliseconds ==
                                0;
                            ...
                            return Column(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: DateTime(date.year, date.month,
                                              date.day) ==
                                          DateTime(itemValue.year,
                                              itemValue.month, itemValue.day)
                                      ? Container(
                                          height: 40.sp,
                                          width: 36.sp,
                                          decoration: BoxDecoration(
                        ...
                        if (selectedMaster != null)
                          (_createAppointmentProvider.masterViewStatus ==
                                  Status.loading)
                              ? const Center(child: CircularProgressIndicator())
                              : (!_salonProfileProvider.isSingleMaster)
                                  ? (_createAppointmentProvider.allAppointments[
                                      ...
                                      : Center(
                                          child: GridView.builder(
                                            ...
                                            gridDelegate:
                                              ...
                                              crossAxisCount: DeviceConstraints
                                            ...
                                            itemBuilder: (context, index) {
                                              List<String> appointmentString =
                                                  _createAppointmentProvider
                                                              .allAppointments[
                                                          selectedMaster
                                                              ?.masterId] ??
                                                      [];
                                              final String _appointment =
                                                  appointmentString[index];
                                          ...
                                          itemBuilder: (context, i) {
                                            ...
                                            if (_createAppointmentProvider
                                              ...
                                              slotsList =
                                                  _createAppointmentProvider
                                                      .morningAllTimeslots;
                                            } else if (_createAppointmentProvider
                                                    .timeOfDayIndexForSlots ==
                                                1) {
                                              // slotsDay1 = afternoonTimeslots;
                                              slotsList =
                                                  _createAppointmentProvider
                                                      .afternoonAllTimeslots;
                                            } else {
                                            ...
                                            if (i == 0) {
                                              return ShowSlots(
                                                ...
                                                date: _createAppointmentProvider
                                                    .getSelectedDate(i),
                                                timeSlots: slotsList
                                                    .map<String>(
                                                        (e) => e.toString())
                    ...
                    Align(
                      ...
                      child: Visibility(
                        visible: _createAppointmentProvider.showModal &&
                            !_createAppointmentProvider.isNotEnoughSlots,
                        child: InkWell(
                          onTap: () {
                            if (_createAppointmentProvider
                                    .selectedAppointmentSlot !=
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                              ...
                                              Text(
                                                ...
                                                (!_salonProfileProvider
                                                    ...
                                                    ? (_createAppointmentProvider
                                                        ...
                                                        : (_createAppointmentProvider
                                                                        .priceAndDuration[selectedMaster
                                                                            ?.masterId]
                                                                        ?.priceMax !=
                                                                    null &&
                                                                _createAppointmentProvider
                                        ...
                                        children: [
                                          Text(
                                            (!_salonProfileProvider
                                                ...
                                                : "${_createAppointmentProvider.selectedAppointmentSlot} - ${_createAppointmentProvider.selectedSlotEndTime}",
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: theme.textTheme.bodyLarge!
                                                .copyWith(
                                  ...
                                  if (!_createAppointmentProvider.isBlocked &&
                                      !_createAppointmentProvider.isOverlapped)
                                    Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      mainAxisAlignment:
                                          MainAxisAlignment.start,
                                      children: _createAppointmentProvider
                                          .chosenServices
                                          .map(
                                            (service) => ServiceNameAndPrice(
                                              ...
                                              fontSize: DeviceConstraints
                                                  .getResponsiveSize(context,
                                                      14.sp, 18.sp, 16.sp),
                                              priceFontSize: DeviceConstraints
                                                  .getResponsiveSize(context,
                                                      14.sp, 18.sp, 16.sp),
                                            ),
                                          )
                                  ...
                                  if (_createAppointmentProvider.isBlocked)
                                    const AlreadyBooked(),
                                  if (_createAppointmentProvider.isOverlapped)
                                    const AlreadyBooked(),
                                  if (_createAppointmentProvider.isOverlapped ||
                                      _createAppointmentProvider.isBlocked)
                                    SizedBox(height: 20.sp),
                                              ...
                                              onTap: () {
                                                if (selectedMaster == null) {
                                                  showToast(AppLocalizations.of(
                                                              context)
                                                          ?.selectAMasterBeforeProceeding ??
                                                      "Please select a master before proceeding");
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          AppLocalizations.of(context)?.timeAlreadyBooked ??
              'This time is already blocked by other appointment',
          style: theme.textTheme.bodyMedium?.copyWith(
            fontWeight: FontWeight.w400,
            fontSize: 15.sp,
            color: Colors.grey,
...
class _ShowSlotsState extends ConsumerState<ShowSlots> {
  ...
  int count() => tooManySlots
      ? (isExpanded ? widget.timeSlots!.length : maxCount)
      ...
      children: [
        (widget.timeSlots == null || widget.timeSlots!.isEmpty)
            ...
            : GridView.builder(
                ...
                padding: const EdgeInsets.only(
                    left: 16, right: 16, bottom: 16, top: 22),
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: DeviceConstraints.getCrossAxisCount(context,
                ...
                itemBuilder: (context, index) {
                  ...
                  return SlotWidget(
                    ...
                    onTap: () {
                      _createAppointmentProvider.onSlotChangeSingleMaster(
                          context, widget.date, widget.timeSlots![index]);
                    },
                    slot: widget.timeSlots![index],
                    isAvailable: _createAppointmentProvider
                        .slots[widget.masterSlotIndex!]!
                        .contains(widget.timeSlots![index]),
                    isSelected: preSelectedSlot == null
                        ? false
                        : (_createAppointmentProvider.selectedAppointmentDate ==
                                        widget.date
                                    ? (DateTime(widget.date!.year, widget.date!.month, widget.date!.day, 0, 0, 0)
                                        ...
                                        .isAfter(
                                          DateTime(
                                              ...
                                              .add(Duration(
                                            hours: int.parse(
                                                preSelectedSlot!.split(":")[0]),
                                            minutes: int.parse(preSelectedSlot!
                                                    .split(":")[1]) -
                                                1,
                                          )),
                                        ))
                                    : false) &&
                                _createAppointmentProvider.selectedAppointmentSlot !=
                                    null &&
                                _createAppointmentProvider.servicePrice !=
                                    null &&
                                _createAppointmentProvider.selectedAppointmentDate ==
                                    widget.date
                            ? (DateTime(widget.date!.year, widget.date!.month, widget.date!.day, 0, 0, 0)
                                .add(Duration(
                                    hours: int.parse(widget.timeSlots![index].split(":")[0]),
                                    minutes: int.parse(widget.timeSlots![index].split(":")[1])))
                                .isBefore(
                                  DateTime(
                                          widget.date!.year,
                                          widget.date!.month,
      ...
      child: !isAvailable
          ...
          : Ink(
              decoration: BoxDecoration(
                color: isSelected
                    ? theme.colorScheme.secondary
                    : theme.dialogBackgroundColor, //  Colors.white,
