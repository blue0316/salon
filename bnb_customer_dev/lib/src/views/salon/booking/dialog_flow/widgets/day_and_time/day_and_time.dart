  ...
  Widget build(BuildContext context) {
    ...
    return loading
        ...
        : (_createAppointmentProvider.salonMasters.isEmpty || _createAppointmentProvider.mastersOfferingChosenServices.isEmpty)
            ? Padding(
                padding: EdgeInsets.symmetric(horizontal: DeviceConstraints.getResponsiveSize(context, 17.w, 17.w, 20.w)),
                child: Column(
                  ...
                  Padding(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        if (!_salonProfileProvider.isSingleMaster)
                          SizedBox(
                            height: DeviceConstraints.getResponsiveSize(context, 45.h, 50.h, 45.h),
                            child: ListView(
                              shrinkWrap: true,
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(
                                                ...
                                                color: (selectedMaster == master) ? theme.colorScheme.secondary : Colors.transparent,
                                                borderRadius: BorderRadius.circular(70),
                                                border: Border.all(
                                                  // color: (selectedMaster == master && isAnyoneSelected == false) ? theme.primaryColor : const Color(0XFF4A4A4A),
                                                  color: (selectedMaster == master) ? theme.colorScheme.secondary : const Color(0XFF4A4A4A),
                                                  width: 0.8,
                                                ),
                                              ),
                                              child: Padding(
                                                          ...
                                                          : Center(
                                                              child: Text(
                                                                ...
                                                                style: theme.textTheme.titleMedium!.copyWith(
                                                                  fontSize: DeviceConstraints.getResponsiveSize(context, 16.sp, 15.sp, 16.sp),
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Icon(
                                ...
                                size: DeviceConstraints.getResponsiveSize(context, 16.sp, 15.sp, 18.sp),
                                color: theme.colorScheme.tertiary,
                              ),
                            ),
                            SizedBox(width: 8.w),
                            Text(
                              ...
                              style: theme.textTheme.bodyMedium?.copyWith(
                                fontWeight: FontWeight.normal,
                                fontSize: DeviceConstraints.getResponsiveSize(context, 16.sp, 15.sp, 18.sp),
                                color: theme.colorScheme.tertiary,
                                fontFamily: 'Inter',
                              ),
                            ),
                                      ...
                                      ? Container(
                                          ...
                                          child: Align(
                                            ...
                                            child: Text(
                                              '${itemValue.day}',
                                              style: TextStyle(
                                                fontSize: DeviceConstraints.getResponsiveSize(context, 14.sp, 14.sp, 16.sp),
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: theme.textTheme.bodyLarge!.copyWith(
                                              fontSize: 16.sp,
                                              fontWeight: FontWeight.normal,
                                              color: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.CityMuseDark ? selectSlots(themeType, theme) : Colors.white,
                                              fontFamily: 'Inter-Medium',
                                            ),
                                          ),
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                style: theme.textTheme.bodyLarge!.copyWith(
                                                  fontSize: 14.sp,
                                                  fontWeight: FontWeight.normal,
                                                  color: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.CityMuseDark ? selectSlots(themeType, theme)?.withOpacity(0.8) : Colors.white,
                                              ...
                                              Padding(
                                                ...
                                                child: CircleAvatar(
                                                  ...
                                                  backgroundColor: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.CityMuseDark ? selectSlots(themeType, theme) : Colors.white,
                                                ),
                                              ),
                                              SizedBox(width: 7.sp),
                                              Text(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: theme.textTheme.bodyLarge!.copyWith(
                                              fontSize: 14.sp,
                                              fontWeight: FontWeight.normal,
                                              color: themeType != ThemeType.GentleTouchDark && themeType != ThemeType.CityMuseDark ? selectSlots(themeType, theme)?.withOpacity(0.7) : Colors.white,
                                              fontFamily: 'Inter-Medium',
                                            ),
                                          ),
                                        ],
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return InkWell(
      ...
      child: !isAvailable
          ...
          : Ink(
              decoration: BoxDecoration(
                color: isSelected ? theme.colorScheme.secondary : theme.dialogBackgroundColor, //  Colors.white,
