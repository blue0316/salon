      ...
      child: Dialog(
        ...
        insetPadding: EdgeInsets.symmetric(
          horizontal: DeviceConstraints.getResponsiveSize(
            context,
            0,
            0, // mediaQuery.width / 5,
            (MediaQuery.of(context).size.height <= 800) ? mediaQuery.width / 6 : 0,
          ),
          vertical: DeviceConstraints.getResponsiveSize(context, 0, 0, 50.h),
        ),
        child: SizedBox(
          child: Padding(
                  ...
                  Expanded(
                    ...
                    child: SizedBox(
                      ...
                      width: DeviceConstraints.getResponsiveSize(
                        ...
                        mediaQuery.width / 1.1, // double.infinity - 15,
