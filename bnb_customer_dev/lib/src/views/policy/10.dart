    ...
    return Column(children: [
      RichText(
        ...
        TextSpan(
            ...
            style: TextStyle(
                ...
                // color: Colors.blue[800],
                decoration: TextDecoration.underline)),
        TextSpan(text: "\n\n     (1) every individual who is in the State of California for other than a temporary or transitory purpose and\n     (2) every individual who is domiciled in the State of California who is outside the State of California for a temporary or transitory purpose", style: TextStyle(fontWeight: FontWeight.bold)),
        TextSpan(
      ...
      Padding(
        ...
        child: Container(
            ...
            child: Table(defaultColumnWidth: FixedColumnWidth(MediaQuery.of(context).size.width / 4.1), border: TableBorder.all(color: Colors.black, style: BorderStyle.solid, width: 1), children: [
              TableRow(children: [
                Center(
                  child: Text(
                    "Category",
                    style: Theme.of(context).textTheme.headline1!.copyWith(decoration: TextDecoration.underline, fontSize: 16, color: const Color.fromARGB(255, 76, 75, 75), fontWeight: FontWeight.bold),
                  ),
                ),
                Center(
                  child: Text(
