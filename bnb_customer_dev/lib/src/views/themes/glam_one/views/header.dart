...
class GlamOneWrap extends ConsumerStatefulWidget {
  final String text;
  ...
  @override
  ConsumerState<GlamOneWrap> createState() => _GlamOneWrapState();
}

class _GlamOneWrapState extends ConsumerState<GlamOneWrap> {
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: FittedBox(
            ...
            child: BackdropFilter(
              ...
              child: Container(
                decoration: (themeType != ThemeType.GentleTouch && themeType != ThemeType.GentleTouchDark)
                    ? BoxDecoration(
                        border: widget.showBorder ? Border.all(color: Colors.white, width: 1) : null,
                        color: widget.color,
                      )
                    : ShapeDecoration(
                        color: const Color.fromARGB(255, 116, 116, 116).withOpacity(0.3),
                        shape: RoundedRectangleBorder(
                          side: BorderSide(
                            width: 1,
                            color: !isHovered ? const Color(0xFFA5A5A5) : Colors.white,
                          ),
                          borderRadius: BorderRadius.circular(2),
                        ),
                      ),
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal: 30.sp,
                    vertical: (themeType == ThemeType.GentleTouch || themeType == ThemeType.GentleTouchDark) ? 10.sp : widget.vSpacing ?? 13.sp,
                  ),
                  child: Center(
                    child: Text(
        ...
        //           shape: RoundedRectangleBorder(
        //             side: !isHovered
        //                 ? const BorderSide(width: 1, color: Color(0xFFA5A5A5))
        //                 : const BorderSide(
        //                     width: 1.5,
        //                     color: Colors.white,
        //                   ),
        ...
        //         ),
        //   child: Padding(
        //     padding: EdgeInsets.symmetric(horizontal: 30.sp, vertical: (themeType == ThemeType.GentleTouch || themeType == ThemeType.GentleTouchDark) ? 10.sp : widget.vSpacing ?? 13.sp),
        //     child: Center(
        //       child: Text(
        //         widget.text.toTitleCase(),
        //         style: theme.textTheme.bodyLarge!.copyWith(color: Colors.white),
