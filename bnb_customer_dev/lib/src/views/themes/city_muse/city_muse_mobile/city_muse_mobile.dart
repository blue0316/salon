...
class GlamMinimalPhone extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _GlamMinamlPhoneState();
}
...
class _GlamMinamlPhoneState extends ConsumerState<GlamMinimalPhone> {
  ...
  final List<String> tabs2 = ["All", "Makeup", "Shaving", "Eyebrows & Eyelashes"];
  ...
  void initState() {
    super.initState();
    ref.read(salonSearchProvider).getAllSalonServices(ref.read(createAppointmentProvider));
  ...
  List<Country> countries = countryCodes.map((country) => Country.from(json: country)).toList();
  int selectedIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leadingWidth: 50,
        backgroundColor: _salonProfileProvider.salonTheme.appBarTheme.backgroundColor,
        leading: chosenSalon.salonLogo.isEmpty
            ? Padding(
                ...
                child: SizedBox(
                  ...
                  width: 100.h,
                  child: Center(
                    child: Text(chosenSalon.salonName.initials, style: TextStyle(fontFamily: "VASQUZ", color: _salonProfileProvider.salonTheme.appBarTheme.titleTextStyle!.color, fontWeight: FontWeight.bold, fontSize: 14)),
                  ),
                ),
              )
            : SizedBox(
                ...
                child: Padding(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: CachedNetworkImageProvider(chosenSalon.salonLogo, maxHeight: 20, maxWidth: 20
                        //fit: BoxFit.cover,
                        ),
                  ),
                ),
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: SvgPicture.asset(
                ...
                color: _salonProfileProvider.salonTheme.appBarTheme.titleTextStyle!.color,
              ),
            ),
          ),
        ],
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: SizedBox(
                //   width: 409,
                height: _salonProfileProvider.themeSettings!.showSignature! && _salonProfileProvider.themeSettings!.themeSignature != null ? 240 : 70,
                child: Column(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        ...
                        style: GoogleFonts.openSans(
                          color: _salonProfileProvider.salonTheme.textTheme.titleLarge!.color,
                          fontSize: 46,
                    ...
                    const Gap(7),
                    if (_salonProfileProvider.themeSettings!.showSignature! && _salonProfileProvider.themeSettings!.themeSignature != null)
                      Expanded(
                        child: Text(
                          'by ${_salonProfileProvider.themeSettings!.themeSignature}',
                          textAlign: TextAlign.right,
                          style: GoogleFonts.ooohBaby(
                            color: _salonProfileProvider.salonTheme.textTheme.displaySmall!.color,
                            fontSize: 30,
            ...
            const Gap(54),
            if (chosenSalon.specializations != null && chosenSalon.specializations!.isNotEmpty && displaySettings!.showSpecialization)
              Padding(
                padding: const EdgeInsets.only(left: 20.0),
                child: Wrap(
            ...
            const Gap(18),
            (_salonProfileProvider.themeSettings?.backgroundImage != null && _salonProfileProvider.themeSettings?.backgroundImage != '')
                ? CachedImage(
            ...
            if (chosenSalon.additionalFeatures.isNotEmpty && displaySettings!.showFeatures)
              ListView.builder(
                ...
                itemBuilder: (context, index) => FeaturesCheck(
                  title: getFeature(
                    _salonProfileProvider.chosenSalon.additionalFeatures[index],
                    chosenSalon.locale,
                  ),
                  index: index,
                ),
            ...
            Gap(100.h),
            if (chosenSalon.description.isNotEmpty && displaySettings!.showAbout) ...[
              SizedBox.fromSize(size: Size.zero, key: controller.about),
              Padding(
                padding: const EdgeInsets.only(left: 18.0, right: 8.0),
                child: Text(
                  _createAppointmentProvider.salonMasters.length > 1 ? 'WHO ARE WE?' : 'WHO AM I?',
                  textAlign: TextAlign.start,
                  style: GoogleFonts.openSans(
                    color: _salonProfileProvider.salonTheme.textTheme.displaySmall!.color,
                    fontSize: 40,
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.openSans(
                      color: _salonProfileProvider.salonTheme.textTheme.titleSmall!.color,
                      fontSize: 16,
                      // fontFamily: 'Open Sans',
                      fontWeight: FontWeight.w400,
                      height: 1.5,
            ...
            Container(
              ...
              child: Marquee(
                text: _salonProfileProvider.allProductBrands.map((e) => e.brandName).toList().join('    ').toCapitalized(),
                style: GoogleFonts.openSans(
                  fontSize: 15.0,
                  color: _salonProfileProvider.salonTheme.textTheme.displaySmall!.color,
                ),
            ...
            if (chosenSalon.photosOfWorks != null && chosenSalon.photosOfWorks!.isNotEmpty && displaySettings!.showPhotosOfWork) ...[
                        ...
                        return Center(
                          child: Column(
                            ...
                            children: [
                              Expanded(
                                child: CachedImage(
                                  url: chosenSalon.photosOfWorks![index].image.toString(),
                                  width: size.width,
                                  fit: BoxFit.cover,
                                  height: 296,
                                ),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(border: chosenSalon.photosOfWorks![currentPortfolioIndex].description == null || chosenSalon.photosOfWorks![currentPortfolioIndex].description!.isEmpty ? null : const Border(bottom: BorderSide(color: Color(0xFF282828)), right: BorderSide(color: Color(0xFF282828)), left: BorderSide(color: Color(0xFF282828)))
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        chosenSalon.photosOfWorks![index].description.toString(),
                                        style: GoogleFonts.openSans(
                                          color: _salonProfileProvider.salonTheme.textTheme.displaySmall!.color,
                                          fontSize: 16,
                                          //  fontFamily: 'Onest',
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: CircleAvatar(
                            radius: 5,
                            backgroundColor: currentPortfolioIndex == index ? _salonProfileProvider.salonTheme.colorScheme.outlineVariant : _salonProfileProvider.salonTheme.colorScheme.outline,
                          ),
                        );
                      },
                      itemCount: chosenSalon.photosOfWorks!.length),
            ...
            if (displaySettings!.services.showServices) ...[
              ...
              Padding(
                padding: const EdgeInsets.only(left: 18.0, right: 8.0),
                child: Text(
                  (AppLocalizations.of(context)?.services ?? 'SERVICES').toUpperCase(),
                  textAlign: TextAlign.start,
                  style: GoogleFonts.openSans(
                    color: _salonProfileProvider.salonTheme.textTheme.displaySmall!.color,
                    fontSize: 40,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: GoogleFonts.openSans(
                                color: _currentServiceIndex == index ? _salonProfileProvider.salonTheme.colorScheme.secondary : _salonProfileProvider.salonTheme.textTheme.bodyMedium!.color,
                                fontSize: 16,
                                // _currentIndex == index
                                //     ? Colors.white
                ...
                child: Padding(
                  ...
                  child: Builder(builder: (_) {
                    if (_currentServiceIndex == 0) {
                      ...
                      return CityMuseServiceTile(allServiceList: allServiceList, pageController: _pageController);
                    }
                    ...
                    for (List<ServiceModel> serviceList in _createAppointmentProvider.servicesAvailable) {
                      for (var ser in serviceList) {
                        ...
                        if (selectedCatId == ser.categoryId) {
                          return CityMuseServiceTile(allServiceList: serviceList, pageController: _pageController);
                        }
                      }
                    }
            ...
            if (displaySettings.product.showProduct && _salonProfileProvider.allProducts.isNotEmpty) ...[
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    scrollDirection: Axis.horizontal,
                    itemCount: _salonProfileProvider.tabs.entries.length + 1,
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          if (_currentProductIndex == 0) {
                            ...
                            setState(() => currentSelectedEntry = catList[index].categoryName);
                            //}
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              catList[index].categoryName.toString().toCapitalized(),
                              style: GoogleFonts.openSans(
                                fontSize: 16,
                                color: _currentProductIndex == index ? _salonProfileProvider.salonTheme.colorScheme.secondary : _salonProfileProvider.salonTheme.textTheme.bodyMedium!.color,
                                // _currentIndex == index
                                //     ? Colors.white
                                //     : Colors.black, // Change the text color
                              ),
                  ...
                  return Column(
                    children: [
                      CarouselSlider.builder(
                        ...
                        itemBuilder: (BuildContext context, int index, int realIndex) {
                          return AllProductWidget(salonProfileProvider: _salonProfileProvider, size: size, index: index, chosenSalon: chosenSalon);
                        },
                      ),
                      Center(
                        child: SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: CircleAvatar(
                                    radius: 5,
                                    backgroundColor: _currentProductImageIndex == index ? _salonProfileProvider.salonTheme.colorScheme.outlineVariant : _salonProfileProvider.salonTheme.colorScheme.outline,
                                  ),
                                );
                              },
                              itemCount: _salonProfileProvider.allProducts.length),
                  ...
                  return Column(
                    children: [
                      CarouselSlider.builder(
                        ...
                        itemCount: _salonProfileProvider.tabs[currentSelectedEntry]?.length,
                        itemBuilder: (BuildContext context, int index, int realIndex) {
            ...
            if (displaySettings.showTeam && _createAppointmentProvider.salonMasters.isNotEmpty) ...[
                ...
                itemBuilder: (BuildContext context, int index, int realIndex) {
                  return GestureDetector(
                    onTap: () {
                      ...
                      _salonProfileProvider.changeSelectedMasterView(_createAppointmentProvider.salonMasters[index]);
                      _salonProfileProvider.changeCurrentIndex(index);
                      // });
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const MastersView()));
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        (_createAppointmentProvider.salonMasters[index].profilePicUrl != null && _createAppointmentProvider.salonMasters[index].profilePicUrl != '')
                            ? Expanded(
                                child: Padding(
                                  ...
                                  child: Center(
                                      child: CachedImage(
                                    url: '${_createAppointmentProvider.salonMasters[index].profilePicUrl}',
                            ...
                            : Expanded(
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 10.0, right: 10.0),
                                  child: Image.asset(
                                    _salonProfileProvider.themeType == ThemeType.CityMuseLight ? ThemeImages.noTeamMemberLightCityMuse : ThemeImages.noTeamMemberDarkCityMuse,
                                    // fit: BoxFit.cover,
                                    width: size.width / 1.1,
                                    height: 589,
                                    fit: BoxFit.cover,
                        ...
                        if (_createAppointmentProvider.salonMasters[index].title != null) ...[
                          const Gap(10),
                          Padding(
                            padding: const EdgeInsets.only(left: 20.0, right: 8.0),
                            child: Text(
                              _createAppointmentProvider.salonMasters[index].title.toString(),
                              textAlign: TextAlign.center,
                              style: GoogleFonts.openSans(
            ...
            if (_salonProfileProvider.salonReviews.isNotEmpty && displaySettings.reviews.showReviews) ...[
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                      getTotalRatings(_salonProfileProvider.salonReviews).toStringAsFixed(1).toString(),
                      textAlign: TextAlign.center,
                      style: GoogleFonts.openSans(
                        color: _salonProfileProvider.salonTheme.textTheme.displaySmall!.color,
                        fontSize: 16,
                    ...
                    RatingBar.builder(
                      initialRating: getTotalRatings(_salonProfileProvider.salonReviews), // reviewStars ?? 5,
                      minRating: 0,
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: CircleAvatar(
                            radius: 5,
                            backgroundColor: currentReviewIndex == index ? _salonProfileProvider.salonTheme.colorScheme.outlineVariant : _salonProfileProvider.salonTheme.colorScheme.outline,
                          ),
                        );
                      },
                      itemCount: _salonProfileProvider.salonReviews.length),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: textFieldStyle("Full Name", _salonProfileProvider),
                ),
              ),
            ),
            const Gap(20),
                        ...
                        decoration: InputDecoration(
                            prefixIcon: GestureDetector(
                              ...
                              child: SizedBox(
                                // height: 170,
                                child: Padding(
                                  padding: const EdgeInsets.only(top: 10.0, left: 10.0, right: 2),
                                  child: Text(
                                    "+" + _salonProfileProvider.selectedCountry.phoneCode,
                                    style: _salonProfileProvider.salonTheme.textTheme.displayLarge,
                                  ),
                                ),
                              ),
                            ),
                            ...
                            fillColor: _salonProfileProvider.salonTheme.inputDecorationTheme.fillColor,
                            border: _salonProfileProvider.salonTheme.inputDecorationTheme.border,
                            enabledBorder: _salonProfileProvider.salonTheme.inputDecorationTheme.enabledBorder,
                            focusedBorder: _salonProfileProvider.salonTheme.inputDecorationTheme.focusedBorder),
                      ),
                    )),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return CountryCodeCard(
                        ...
                        onTap: () {
                          setState(() {
                            selectedIndex = index;
                            _salonProfileProvider.selectedCountry = country;
                            showPicker = !showPicker;
                          });
                        },
                      );
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: textFieldStyle("Email", _salonProfileProvider),
                ),
              ),
            ),
            const Gap(20),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  // minLines: 0,
                  maxLines: 10,
                  decoration: textFieldStyle("Write to Us", _salonProfileProvider),
                ),
              ),
            ),
            const Gap(30),
            GestureDetector(
              onTap: () {
                _salonProfileProvider.sendEnquiryToSalonCityMuse(context, salonId: chosenSalon.salonId);
              },
              child: _salonProfileProvider.enquiryStatus == Status.loading
                  ? Center(
                      child: SizedBox(
                        height: 30,
                        width: 30,
                        child: CircularProgressIndicator(color: _salonProfileProvider.salonTheme.colorScheme.secondary),
                      ),
                    )
                  : Padding(
                      padding: const EdgeInsets.only(left: 18.0, right: 18.0),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 18.0, right: 18.0),
              child: Container(height: 1, width: double.infinity, color: const Color(0xFFB8B2A6)),
            ),
            const Gap(40),
            Center(
              child: Container(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Text('BOOK NOW', style: GoogleFonts.openSans(color: _salonProfileProvider.salonTheme.colorScheme.secondary, fontSize: 18, fontWeight: FontWeight.w700)),
            const Gap(10),
            // ColorFiltered(
            //   colorFilter: ColorFilter.mode(_salonProfileProvider.salonTheme.colorScheme.secondary, BlendMode.src),
            //   child: Image.asset(
